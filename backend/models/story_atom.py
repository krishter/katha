...
class StoryAtom(Base):
    ...
    when_approx: Mapped[str | None] = mapped_column(Text, nullable=True)
    where_approx: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    audio_timestamp_start: Mapped[float | None] = mapped_column(Float, nullable=True)
    audio_timestamp_end: Mapped[float | None] = mapped_column(Float, nullable=True)
